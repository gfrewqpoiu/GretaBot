...
class Select(SelectBase):
    def __init__(self, from_list: Optional[Any] = ..., columns: Optional[Any] = ..., group_by: Optional[Any] = ..., having: Optional[Any] = ..., distinct: Optional[Any] = ..., windows: Optional[Any] = ..., for_update: Optional[Any] = ..., for_update_of: Optional[Any] = ..., nowait: Optional[Any] = ..., lateral: Optional[Any] = ..., **kwargs: Any) -> None: ...
    def clone(self): ...
...
class ForeignKeyField(Field):
    ...
    lazy_load: Any = ...
    constraint_name: Any = ...
    def __init__(self, model: Any, field: Optional[Any] = ..., backref: Optional[Any] = ..., on_delete: Optional[Any] = ..., on_update: Optional[Any] = ..., deferrable: Optional[Any] = ..., _deferred: Optional[Any] = ..., rel_model: Optional[Any] = ..., to_field: Optional[Any] = ..., object_id_name: Optional[Any] = ..., lazy_load: bool = ..., constraint_name: Optional[Any] = ..., related_name: Optional[Any] = ..., *args: Any, **kwargs: Any) -> None: ...
    @property
    def field_type(self): ...
    def get_modifiers(self): ...
    def adapt(self, value: Any): ...
