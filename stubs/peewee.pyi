...
class Context:
    ...
    def value(
        self, value: Any, converter: Optional[Any] = ..., add_param: bool = ...
    ): ...
...
class Table(_HashableSource, BaseTable):
    ...
    def select(self, *columns: Any): ...
    def insert(
        self, insert: Optional[Any] = ..., columns: Optional[Any] = ..., **kwargs: Any
    ): ...
    def replace(
        self, insert: Optional[Any] = ..., columns: Optional[Any] = ..., **kwargs: Any
    ): ...
...
class ColumnBase(Node):
    def converter(self, converter: Optional[Any] = ...) -> None: ...
...
class Value(ColumnBase):
    ...
    values: Any = ...
    def __init__(
        self, value: Any, converter: Optional[Any] = ..., unpack: bool = ...
    ) -> None: ...
    def __sql__(self, ctx: Any): ...
...
def Check(constraint: Any, name: Optional[Any] = ...): ...
...
class ForUpdate(Node):
    def __init__(
        self, expr: Any, of: Optional[Any] = ..., nowait: Optional[Any] = ...
    ) -> None: ...
    def __sql__(self, ctx: Any): ...
...
class Select(SelectBase):
    ...
    def join(
        self, dest: Any, join_type: Any = ..., on: Optional[Any] = ...
    ) -> None: ...
...
class _WriteQuery(Query):
    table: Any = ...
    def __init__(
        self, table: Any, returning: Optional[Any] = ..., **kwargs: Any
    ) -> None: ...
...
class Update(_WriteQuery):
    def __init__(
        self, table: Any, update: Optional[Any] = ..., **kwargs: Any
    ) -> None: ...
    def from_(self, *sources: Any) -> None: ...
    def __sql__(self, ctx: Any): ...
...
class Database(_callable_context_manager):
    ...
    def random(self): ...
    def bind(
        self, models: Any, bind_refs: bool = ..., bind_backrefs: bool = ...
    ) -> None: ...
    def bind_ctx(
        self, models: Any, bind_refs: bool = ..., bind_backrefs: bool = ...
    ): ...
...
class SqliteDatabase(Database):
    ...
    def register_table_function(
        self, klass: Any, name: Optional[Any] = ...
    ) -> None: ...
...
class _BaseFormattedField(Field):
    formats: Any = ...
    def __init__(
        self, formats: Optional[Any] = ..., *args: Any, **kwargs: Any
    ) -> None: ...
...
class BareField(Field):
    adapt: Any = ...
    def __init__(
        self, adapt: Optional[Any] = ..., *args: Any, **kwargs: Any
    ) -> None: ...
...
class VirtualField(MetaField):
    ...
    field_instance: Any = ...
    def __init__(
        self, field_class: Optional[Any] = ..., *args: Any, **kwargs: Any
    ) -> None: ...
    def db_value(self, value: Any): ...
    def python_value(self, value: Any): ...
    model: Any = ...
...
class SchemaManager:
    ...
    def truncate_table(
        self, restart_identity: bool = ..., cascade: bool = ...
    ) -> None: ...
    ...
    def drop_all(
        self, safe: bool = ..., drop_sequences: bool = ..., **options: Any
    ) -> None: ...
...
class Metadata:
    ...
    def add_field(
        self, field_name: Any, field: Any, set_attribute: bool = ...
    ) -> None: ...
...
class _BoundModelsContext(_callable_context_manager):
    ...
    bind_backrefs: Any = ...
    def __init__(
        self, models: Any, database: Any, bind_refs: Any, bind_backrefs: Any
    ) -> None: ...
    def __enter__(self): ...
    def __exit__(self, exc_type: Any, exc_val: Any, exc_tb: Any) -> None: ...
...
class Model:
    ...
    @classmethod
    def bulk_update(
        cls, model_list: Any, fields: Any, batch_size: Optional[Any] = ...
    ): ...
    @classmethod
    def noop(cls): ...
    @classmethod
    ...
    def bind(
        ...
        bind_refs: bool = ...,
        bind_backrefs: bool = ...,
        _exclude: Optional[Any] = ...,
    ): ...
    @classmethod
    def bind_ctx(
        cls, database: Any, bind_refs: bool = ..., bind_backrefs: bool = ...
    ): ...
    @classmethod
    ...
    @classmethod
    def drop_table(
        cls, safe: bool = ..., drop_sequences: bool = ..., **options: Any
    ) -> None: ...
    @classmethod
...
class ModelSelect(BaseModelSelect, Select):
    model: Any = ...
    def __init__(
        self, model: Any, fields_or_models: Any, is_default: bool = ...
    ) -> None: ...
    def clone(self): ...
    ...
    def ensure_join(
        self, lm: Any, rm: Any, on: Optional[Any] = ..., **join_kwargs: Any
    ): ...
...
class ModelObjectCursorWrapper(ModelDictCursorWrapper):
    ...
    is_model: Any = ...
    def __init__(
        self, cursor: Any, model: Any, select: Any, constructor: Any
    ) -> None: ...
    def process_row(self, row: Any): ...
